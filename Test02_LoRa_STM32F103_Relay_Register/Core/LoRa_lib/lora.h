...
#define FREQ_433_02MHZ		1
#define FREQ_433_15MHZ		2
#define FREQ_865MHZ			3
#define FREQ_866MHZ			4
#define FREQ_867MHZ			5


static const uint64_t FREQUENCY[6] = { 433E6, 433.02E6, 433.15E6, 865E6, 866E6, 867E6};
